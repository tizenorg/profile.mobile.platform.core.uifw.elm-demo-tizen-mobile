...
create_description(Evas_Object *parent)
{
	...
	elm_atspi_accessible_name_set(btn, _("IDS_BUTTON_NAME"));
...
static Evas_Object*
create_description_2(Evas_Object *parent)
{
	Evas_Object *btn;
	Evas_Object *layout;
	Evas_Object *img;
...
void
description_2_cb(void *data, Evas_Object *obj, void *event_info)
{
	Evas_Object *layout;
	Evas_Object *nf = data;

	layout = create_description_2(nf);
	elm_naviframe_item_push(nf, "UI Descriptions 2", NULL, NULL, layout, NULL);
}
