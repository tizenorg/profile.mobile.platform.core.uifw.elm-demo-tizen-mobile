...
#undef  LOG_TAG
#endif
#define LOG_TAG "elm-demo-tizen-mobile"

#if !defined(PACKAGE)
#define PACKAGE "org.tizen.elm-demo-tizen-mobile"
#endif

#define ELM_DEMO_EDJ "/opt/usr/apps/org.tizen.elm-demo-tizen-mobile/res/elm-demo-tizen-mobile.edj"
#define ICON_DIR "/opt/usr/apps/org.tizen.elm-demo-tizen-mobile/res/images"
